...
@WebServlet(name = "OgrenciGuncelleServlet", value = "/ogrenciGuncelle")
public class OgrenciGuncelleServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        RequestDispatcher rs1= request.getRequestDispatcher("ogrenci-guncelle-form.jsp");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try
        {
            ...
            ogrenciVeri.gorevGuncelle(gorevadi,gorevspec);
